...
* To become a proficient computer programmer using Java.
* To make programming an enjoyable activity, such that you look forward to Friday night programming.

At the end of this course, you will be able to:

* Design, implement, test, and document Java programs using good programming style and object-oriented design.
* Effectively test your programs including the use of a debugger.
* Model data and design data types with their associated operations, as exemplified in the Java class structure.
* Understand and use searching and sorting algorithms in your computer programs.
