...
summary: "<li>Understand how to use the Netbeans GUI Builder to create a graphics program.</li>"
sidebar: mydoc_sidebar
permalink: /mydoc_7_netbeans_gui_builder/
---
...
Netbeans has a GUI builder that we use in [Netbeans GUI Builer](/gustycooper/github/io/lab_lab07_02_04) lab.  We will learn the basics of the Netbeans GUI Builder and create a simple GUI with it.
